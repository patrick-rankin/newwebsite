###############################################################################
# NBA — PLAYER DATA INGESTION SCRIPT
...
# Use 03_ingest_nba_team.R for team-level stats instead.
###############################################################################
...
my_player <- "Shai Gilgeous-Alexander"
...
output_folder <- "pipeline/nba/data/player_stats"
###############################################################################
...
player_box <- hoopR::load_nba_player_box(seasons = season_year)
...
# don't have to scroll through every player in the league.
# -----------------------------------------------------------------------------
...
# nba_player_LeBron_James_2026.csv
###############################################################################

player_name_clean <- gsub(" ", "_", my_player)
player_filename <- file.path(output_folder, paste0("nba_player_", player_name_clean, "_", season_year, ".csv"))
