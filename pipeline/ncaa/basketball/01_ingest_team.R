###############################################################################
# NCAA MEN'S BASKETBALL — TEAM DATA INGESTION SCRIPT
...
# totals, one row per game. Use 02_ingest_player.R for player-level stats.
###############################################################################
...
# Which team do you want? Use the school's common name.
...
# Example: "ncaa_data"
output_folder <- "pipeline/ncaa/basketball/data/team_stats"
...
# team_Saint_Louis_2026.csv
###############################################################################

team_name_clean <- gsub(" ", "_", my_team)
team_filename <- file.path(output_folder, paste0("team_", team_name_clean, "_", season_year, ".csv"))
